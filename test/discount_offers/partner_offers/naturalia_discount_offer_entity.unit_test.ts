...
export class NaturaliaDiscountOfferUnitTests {
    ...
    @test
    givenPositiveExpiresIn_whenApplyingDiscountPolicy_thenDiscountShouldIncreaseBy1() {
    ...
    @test
    givenNegativeExpiresIn_whenApplyingDiscountPolicy_thenDiscountShouldIncreaseBy2() {
        const partnerName = 'test';
        const expiresIn = -10;
        const discountInPercent = 30;
        const offer = new NaturaliaDiscountOfferTestEntity(partnerName, expiresIn, discountInPercent);
    ...
    @test
    givenExpiresInEquals0_whenApplyingDiscountPolicy_thenDiscountShouldIncreaseBy2() {
        const partnerName = 'test';
        const expiresIn = 0;
        const discountInPercent = 30;
        const offer = new NaturaliaDiscountOfferTestEntity(partnerName, expiresIn, discountInPercent);
